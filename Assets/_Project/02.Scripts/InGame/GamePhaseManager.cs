...
public class GamePhaseManager : NetworkBehaviour
{
    ...
    private void SetPhase(GamePhase nextPhase, float duration)
    {
        ...
        if (IsServer && nextPhase == GamePhase.RewardSelection)
        {
            RewardSelectionManager.Instance?.BeginSelectionServer();
        }
    }
    ...
    private void MoveToNextPhase()
    {
        switch (CurrentPhase.Value)
        {
            ...
            case GamePhase.RewardSelection:
                RewardSelectionManager.Instance?.ForceSelectMissingServer();
    ...
    public void CompleteBossInvasion()
    {
        if (!IsServer)
        {
            return;
        ...
        if (CurrentPhase.Value != GamePhase.BossInvasion)
        {
            return;
        }
    ...
    public void CompleteRewardSelection()
    {
        ...
        if (CurrentPhase.Value != GamePhase.RewardSelection)
        {
            return;
        }
